...
| **model**                  | **description**                                                                                                                                               |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [fivetran_log__connector_status](models/fivetran_log__connector_status.sql)        | Each record represents a connector loading data into a destination, enriched with data about the connector's health (is it broken?) and the status of its data flow (what is the status of its current or most recent sync?).                                          |
