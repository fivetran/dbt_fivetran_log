...
staging_model as (
    ...
    group by connection_name, schema_name, table_name, destination_id, {{ dbt.date_trunc('month', 'measured_date') }}
)
...
left join staging_model
    on end_model.connection_name = staging_model.connection_name
