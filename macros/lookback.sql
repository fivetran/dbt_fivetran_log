...
{{ adapter.dispatch('lookback', 'fivetran_log') (from_date, datepart='day', interval=7, default_start_date='2010-01-01') }}
...
{% macro postgres__lookback(from_date, datepart='day', interval=7, default_start_date='2010-01-01')  %}
