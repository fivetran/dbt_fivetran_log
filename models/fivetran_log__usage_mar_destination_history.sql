...
join_usage_mar as (
    ...
    select 
        ...
        round( nullif(usage.consumption,0) * 1000000.0 / nullif(destination_mar.monthly_active_rows,0) * 1.0, 2) as usage_per_million_mar,
        round( nullif(destination_mar.monthly_active_rows,0) * 1.0 / nullif(usage.consumption,0) * 1.0, 0) as mar_per_usage
